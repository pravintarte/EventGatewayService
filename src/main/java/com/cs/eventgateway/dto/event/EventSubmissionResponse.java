 ...
 */
@Schema(description = "Result returned after submitting a transaction event.")
public record EventSubmissionResponse(
        ...
        @Schema(description = "True when the request was an exact idempotent duplicate.", example = "false")
        boolean duplicate,
        ...
        @Schema(description = "Concise processing outcome.", example = ApiCodes.EVENT_ACCEPTED_AND_APPLIED)
        String message,
